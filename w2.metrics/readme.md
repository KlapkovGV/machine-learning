...
**True Positive Rate** and the **False Positive Rate** are the specific metrics used to plot the final ROC curve. The True Positive Rate tells us how good the model is at finding the actual positive cases. 
